            ...
            <div className="wrapper-content">
                <div className="inner-content">
                    ...
                    <div className="heading-section">
                        <h2 className="tf-title pb-30">Propiedades Trending</h2>
                    </div>
                    ...
                    <div className="widget-tabs relative">
                        ...
                        <div className="widget-content-tab">
                            <div className="widget-content-inner" style={{ display: `${activeIndex === 5 ? "block" : "none"}` }}>
                            ...
                            <div className="widget-content-inner" style={{ display: `${activeIndex === 6 ? "block" : "none"}` }}>
                                <div className="wrap-box-card">
                                    <div className="col-item">
                                        <div className="tf-card-box style-1">
                                            <div className="card-media">
                            ...
                            <div className="widget-content-inner" style={{ display: `${activeIndex === 7 ? "block" : "none"}` }}>
                                <div className="wrap-box-card">
                                    <div className="col-item">
                                        <div className="tf-card-box style-1">
                                            <div className="card-media">
                            ...
                            <div className="widget-content-inner" style={{ display: `${activeIndex === 8 ? "block" : "none"}` }}>
                                <div className="wrap-box-card">
                                    <div className="col-item">
                                        <div className="tf-card-box style-1">
                                            <div className="card-media">
